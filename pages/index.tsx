  ...
  return (
    ...
    >
      <header className="border-b-2 py-8">
        ...
        <p><strong>Disclaimer:</strong><em> These definitions were written as part of a learning activity, so it is prone to have errors and is not intended to be in sync with the changes in the respective documentation. </em></p>
      </header>
